...
int main(int argc, char* argv[])
{
	if (argc != 3)
	{
		...
		printf("zs2 - works with Zombie Shooter 2\n");
		printf("asr - works with Alien Shooter Revisited\n");
		printf("as2legend - works with Alien Shooter 2 Legend & TD Steam\n");
	...
	if (in)
	{
		// Alien Shooter 1 - Classic res file with char pad in WEAP section
		...
		{
			{
				...
				// Alien Shooter 1 - NonSteam version
				...
				// Zombie Shooter 2 Engine
				if (strcmp("zs2", argv[2]) == 0)
				{
					{
						//header
						out = ReadInt(in);
				...
				// Objects Extended Project Old versions 1105
