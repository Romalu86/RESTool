...
int main(int argc, char* argv[])
{
	if (argc != 3)
	{
		...
		printf("as1mobile_pad - works with Alien Shooter 1 - World (mobile)\n");
		printf("as1mobile_nonpad - works with Alien Shooter 1 - World (mobile)\n");
		...
		{
			{
				...
				if (strcmp("as1mobile_pad", argv[2]) == 0)
				{
					{
						//header
						out = ReadInt(in);
				...
				// Alien Shooter 1: World (Mobile\PC)
				if (strcmp("as1mobile_nonpad", argv[2]) == 0)
				{
					{
						//header
						out = ReadInt(in);
